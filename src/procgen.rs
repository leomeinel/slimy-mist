...
/// Applies to anything that is generated by procgen and despawnable
pub(crate) trait Despawnable
where
...
pub(crate) fn despawn_procgen<T, A>(
    ...
    T: Despawnable, // Despawnable of the character or level
...
where
    T: Despawnable, // Despawnable associated with controller
{
